        ...
        const defaultAdminProducts = [
            {
                ...
                package: "Cold-chain airfreight box",
                image: "assets/flower_rose.png",
                description: "Long-stemmed, vibrant red roses with a vase life of 12+ days after arrival.",
                isSignature: true
            },
            {
                id: "2",
                name: "White Tuberose (Sampangi)",
                category: "cutflowers",
                grade: "Export Grade Double/Single",
                budLife: "5 - 7 Days",
                availability: "Year-round",
                package: "Controlled moisture wraps",
                image: "assets/flower_tuberose.png",
                description: "Intensely fragrant white flower spikes sorted for stem firmness and diameter.",
                isSignature: true
            },
            {
                id: "3",
                ...
                grade: "AAA Fresh Closed Buds",
                budLife: "3 - 5 Days",
                availability: "Year-round",
                package: "Thermocol insulated boxes",
                image: "assets/flower_jasmine.png",
                description: "A-grade white closed buds harvested at dawn, sealed in thermocol cold packs.",
                isSignature: true
            },
            {
                id: "4",
                ...
                budLife: "3 - 4 Days",
                availability: "Seasonal / Daily",
                package: "Air-ventilated baskets",
            ...
            },
            {
                ...
                name: "Mullai Flowers",
                category: "traditional",
                grade: "Grade A Scented",
                budLife: "3 - 5 Days",
                availability: "Year-round",
                package: "Cooling gel pack boxes",
                image: "assets/flower_lotus.png",
                description: "Exceptional durability and scent, perfect for daily export shipments.",
                isSignature: false
            },
            {
                id: "6",
                ...
                budLife: "3 - 5 Days",
                availability: "Year-round",
                package: "5kg & 10kg loose mesh bags",
                image: "assets/flower_marigold.png",
                description: "High-impact golden-yellow and orange blooms shipped loose or garlanded.",
                isSignature: true
            },
            {
                id: "7",
                name: "Exotic Lotus Blooms",
                category: "seasonal",
                grade: "Export Select",
                budLife: "4 - 6 Days",
                availability: "Seasonal",
                package: "Moisture-sealed stem foam",
                image: "assets/flower_purple.png",
                description: "Pristine lotus blossoms handled with extreme care for luxury events.",
                isSignature: true
            },
            {
                id: "8",
                name: "Wedding Jasmine Garlands",
                category: "traditional",
                grade: "Hand-woven Custom Lengths",
                budLife: "3 - 4 Days",
                availability: "Daily Order",
                package: "Vacuum-sealed cold box",
                image: "assets/flower_garland_full.png",
                description: "Intricately hand-woven garlands using the freshest Madurai Malli varieties.",
                isSignature: true
            }
        ];
    ...
    heritageImage2File.addEventListener('change', (e) => {
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                const group =
                    heritageImage2File.closest('.form-group');
